...
- Ava must treat the Ava masterclass facts in `pbk_knowledge` as her conversation behavior layer: small talk, phone emotional intelligence, authority-vs-understanding, ego navigation, sports/politics deflection, ethical seven-figure closing models, and wholesale deal-path audience rules. All proprietary PBK business material still lives in `pbk_knowledge`, and the masterclass enhances rather than replaces calculators, contracts, approvals, Rex/Hermes, Slack, OpenClaw, or the Electron/dashboard command surface.
- Ava's missing-pieces suite in `pbk_knowledge` is now part of the behavior layer: legal/compliance guardrails, advanced negotiation, multiple decision-makers, trauma-informed selling, cultural fluency, follow-up alchemy, gatekeepers, continuous improvement, vocal persona, market intelligence, DISC-lite personality typing, launch-gap truth, and streaming-TTS behavior. Use it to improve judgment and phrasing, not to give legal advice, invent authority, skip approvals, or ignore PBK calculators/contracts.
