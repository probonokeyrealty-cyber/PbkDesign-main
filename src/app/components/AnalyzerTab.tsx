            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <div className="flex-1">
                  <label htmlFor="deal-arv" className="block text-[12px] text-gray-600 dark:text-gray-400 mb-1">
                    ARV
              ...
              <div className="flex items-start gap-2">
                <div className="flex-1">
                  <label htmlFor="deal-rent" className="block text-[12px] text-gray-600 dark:text-gray-400 mb-1">
              ...
              <div className="flex items-start gap-2">
                <div className="flex-1">
                  <label htmlFor="deal-balance" className="block text-[12px] text-gray-600 dark:text-gray-400 mb-1">
              ...
              <div className="flex items-start gap-2">
                <div className="flex-1">
                  <label htmlFor="deal-rate" className="block text-[12px] text-gray-600 dark:text-gray-400 mb-1">
              ...
              <div className="flex items-start gap-2">
                <div className="flex-1">
                  <label htmlFor="deal-fee" className="block text-[12px] text-gray-600 dark:text-gray-400 mb-1">
      ...
      <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl p-4 mb-3 shadow-sm">
        ...
        <div className="space-y-2">
          {(['A', 'B', 'C'] as const).map((comp) => (
            ...
            >
              <span className="text-[11px] font-bold text-blue-500 text-center w-6" aria-hidden="true">{comp}</span>
              <input
                type="text"
                inputMode="text"
                enterKeyHint="next"
              ...
              <div className="flex items-center bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded px-2 h-7">
                <span className="text-[11.5px] text-gray-500" aria-hidden="true">$</span>
                <input
                  type="number"
